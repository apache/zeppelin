...
<table class="table-configuration">
  ...
  <tr>
    ...
    <td>mongosh</td>
    <td markdown="span">MongoDB shell local path. <br/> Use `which mongosh` to get local path in linux or mac. <br>(For below [version 5.0](https://www.mongodb.com/docs/manual/release-notes/5.0/#shell-changes), check `mongo`)</td>
  </tr>
  <tr>
