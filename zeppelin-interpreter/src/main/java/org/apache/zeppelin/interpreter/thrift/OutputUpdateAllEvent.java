...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2026-09-20")
public class OutputUpdateAllEvent implements org.apache.thrift.TBase<OutputUpdateAllEvent, OutputUpdateAllEvent._Fields>, java.io.Serializable, Cloneable, Comparable<OutputUpdateAllEvent> {
  ...
  private static final org.apache.thrift.protocol.TField EXECUTION_OWNER_FIELD_DESC = new org.apache.thrift.protocol.TField("executionOwner", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String executionOwner; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.EXECUTION_OWNER, new org.apache.thrift.meta_data.FieldMetaData("executionOwner", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public OutputUpdateAllEvent setExecutionOwner(@org.apache.thrift.annotation.Nullable java.lang.String executionOwner) {
    this.executionOwner = executionOwner;
    return this;
  }
  ...
  /** Returns true if field executionOwner is set (has been assigned a value) and false otherwise */
  ...
  public int compareTo(OutputUpdateAllEvent other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExecutionOwner()).compareTo(other.isSetExecutionOwner());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExecutionOwner()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.executionOwner, other.executionOwner);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
