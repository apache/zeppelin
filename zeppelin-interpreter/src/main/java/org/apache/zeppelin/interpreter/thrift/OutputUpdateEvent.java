...
public class OutputUpdateEvent implements org.apache.thrift.TBase<OutputUpdateEvent, OutputUpdateEvent._Fields>, java.io.Serializable, Cloneable, Comparable<OutputUpdateEvent> {
  ...
  private static final org.apache.thrift.protocol.TField EXECUTION_OWNER_FIELD_DESC = new org.apache.thrift.protocol.TField("executionOwner", org.apache.thrift.protocol.TType.STRING, (short)7);
  ...
  public OutputUpdateEvent setExecutionOwner(@org.apache.thrift.annotation.Nullable java.lang.String executionOwner) {
    this.executionOwner = executionOwner;
    return this;
  }
