...
public class PhoenixInterpreterTest {
  ...
  @Test
  public void test() {
    PhoenixInterpreter t = new MockPhoenixInterpreter(new Properties());
    t.open();
...
class MockPhoenixInterpreter extends PhoenixInterpreter {

  public MockPhoenixInterpreter(Properties property) {
    super(property);
  }
