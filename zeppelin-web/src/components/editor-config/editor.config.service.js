...
angular.module('zeppelinWebApp').service('editorConfigSrv', function($q) {
  ...
  var themeSupportLists = [
    ...
    {'themeValue': 'cobalt'},
    {'themeValue': 'crimson_editor'},
    {'themeValue': 'dawn'},
    {'themeValue': 'dreamweaver'},
    {'themeValue': 'eclipse'},
    {'themeValue': 'github'},
    {'themeValue': 'idle_fingers'},
    {'themeValue': 'katzenmilch'},
    {'themeValue': 'kr_theme'},
    {'themeValue': 'kuroir'},
    {'themeValue': 'merbivore'},
    {'themeValue': 'merbivore_soft'},
    {'themeValue': 'mono_industrial'},
    {'themeValue': 'monokai'},
    {'themeValue': 'pastel_on_dark'},
    {'themeValue': 'solarized_dark'},
    {'themeValue': 'solarized_light'},
    {'themeValue': 'terminal'},
    {'themeValue': 'textmate'},
    {'themeValue': 'tomorrow'},
    {'themeValue': 'tomorrow_night'},
