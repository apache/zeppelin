...
if defined SPARK_SUBMIT (
    ...
    echo "%SPARK_SUBMIT%" --class %ZEPPELIN_SERVER% --jars %CLASSPATH% --driver-class-path !ZEPPELIN_INTP_CLASSPATH!;!ZEPPELIN_CLASSPATH! --driver-java-options "!JAVA_INTP_OPTS!" %SPARK_SUBMIT_OPTIONS% !ZEPPELIN_SPARK_CONFW! "%SPARK_APP_JAR%" "%CALLBACK_HOST%" %PORT% "!INTP_GROUP_ID!" !INTP_PORT!
    ...
    set JAVA_INTP_OPTS=%JAVA_INTP_OPTS% -Dzeppelin.log.file="%ZEPPELIN_LOGFILE%"
    echo "%ZEPPELIN_RUNNER%" !JAVA_INTP_OPTS! %ZEPPELIN_INTP_MEM% -cp !ZEPPELIN_INTP_CLASSPATH!;!ZEPPELIN_CLASSPATH! %ZEPPELIN_SERVER% "%CALLBACK_HOST%" %PORT% "!INTP_GROUP_ID!" !INTP_PORT!
    "%ZEPPELIN_RUNNER%" !JAVA_INTP_OPTS! %ZEPPELIN_INTP_MEM% -cp !ZEPPELIN_INTP_CLASSPATH!;!ZEPPELIN_CLASSPATH! %ZEPPELIN_SERVER% "%CALLBACK_HOST%" %PORT% "!INTP_GROUP_ID!" !INTP_PORT!
)
