...
public class Neo4jCypherInterpreterTest {
  ...
  public void testRenderNetwork() {
    ...
    assertEquals(true, graph.getNodes().iterator().next().getDefaultLabel().equals(LABEL_PERSON));
    assertEquals(1, graph.getEdges().size());
    assertEquals(true, graph.getEdges().iterator().next().getDefaultLabel().equals(REL_KNOWS));
