...
./bin/spark-class org.apache.spark.deploy.worker.Worker spark://epahomov-osx.local:7071 &> worker.log &
./bin/spark-class org.apache.spark.deploy.worker.Worker spark://epahomov-osx.local:7071 &> worker2.log &
