...
public class Flink120Shims extends FlinkShims {
  ...
  public Object createCatalogManager(Object config) {
    ...
    final CatalogStoreFactory catalogStoreFactory =
            TableFactoryUtil.findAndCreateCatalogStoreFactory(
                    tableConfig.getConfiguration(), userClassLoader);
  ...
  public Object fromDataSet(Object btenv, Object ds) {
    throw new RuntimeException("Conversion from DataSet is not supported in Flink 1.20");
  }

  @Override
  public Object toDataSet(Object btenv, Object table) {
    throw new RuntimeException("Conversion to DataSet is not supported in Flink 1.20");
  }
  ...
  public boolean isTimeIndicatorType(Object type) {
      return type instanceof TimeIndicatorTypeInfo;
  }
