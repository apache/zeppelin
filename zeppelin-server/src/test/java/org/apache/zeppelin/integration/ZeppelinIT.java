...
public class ZeppelinIT extends AbstractZeppelinIT {
  ...
  public void testAngularDisplay() throws Exception {
    ...
    try {
       ...
       */
      assertEquals(10, driver.findElements(By.xpath(getParagraphXPath(2) + "//textarea")).size());
      ...
      handleError("Exception in ZeppelinIT while testAngularDisplay ", e);
    }
  }
  ...
  public void testSparkInterpreterDependencyLoading() throws Exception {
    ...
    try {
      ...
      handleError("Exception in ZeppelinIT while testSparkInterpreterDependencyLoading ", e);
    }
  }
}
