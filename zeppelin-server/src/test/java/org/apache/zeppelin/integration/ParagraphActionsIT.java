...
public class ParagraphActionsIT extends AbstractZeppelinIT {
  ...
  public void testRunOnSelectionChange() throws Exception {
    ...
    try {
      ...
      String xpathToDropdownMenu = "(" + (getParagraphXPath(1) + "//select)[3]");
  ...
  public void testSingleDynamicFormSelectForm() throws Exception {
    ...
    try {
      ...
      Select dropDownMenu = new Select(driver.findElement(By.xpath("(" + (getParagraphXPath(1) + "//select)[3]"))));
  ...
  public void testMultipleDynamicFormsSameType() throws Exception {
    ...
    try {
      ...
      Select sameDropDownMenu = new Select(driver.findElement(By.xpath("(" + (getParagraphXPath(1) + "//select)[4]"))));
