...
/**
 * Immutable authentication identity captured at a transport boundary.
 *
 * <p>The session identifier is an opaque handle. It must not be exposed to clients or used as an
