...
public class SecurityRestApi {
  ...
  public Response getUserList(@PathParam("searchText") final String searchText) {
    ...
    Collection<String> usersList = SecurityUtils.lookupUsersInRealms(searchText);
    Collection<String> rolesList = SecurityUtils.lookupRolesInRealms(searchText);
    
    Map<String, Collection> returnListMap = new HashMap<>();
