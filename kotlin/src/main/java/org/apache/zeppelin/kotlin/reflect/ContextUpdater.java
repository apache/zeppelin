...
public class ContextUpdater {
  ...
  private List<Object> getLines() {
   ...
   and it contains the functions and variables declared in the paragraph as its methods and fields.
   For example, line "val i = 1" can be compiled to Line_0.class with field "public final int i" set to 1.
