...
public class NotebookTest implements JobListenerFactory{
  ...
  @Test
  public void testLoadAllNotes() throws DuplicateNameException {
    Note note;
    try {
      assertEquals(0, notebook.getAllNotes().size());
      note = notebook.createNote(anonymous, EMPTY_STRING);
      Paragraph p1 = note.addParagraph();
  ...
  @Test
  public void testCreateNoteWithSubject() throws IOException, SchedulerException,
      RepositoryException, DuplicateNameException {
  ...
  public void testCloneNoteWithNoName() throws IOException, CloneNotSupportedException,
    ...
    Note note = notebook.createNote(anonymous, "Note");
    factory.setInterpreters(anonymous.getUser(), note.getId(), factory.getDefaultInterpreterSettingList());
  ...
  public void testCloneNoteWithDuplicateName() throws IOException, IllegalArgumentException, 
    ...
    notebook.cloneNote(note.getId(), "Note", anonymous);
  }
  ...
  public void testCreateNoteWithDuplicateName() throws IOException, DuplicateNameException {
    ...
    notebook.createNote(anonymous, "Note");
  }
  ...
  public void testImportNoteWithDuplicateName() throws IOException, DuplicateNameException {
    ...
    notebook.importNote(exportedNoteJson, "Note", anonymous);
  }
  ...
  public void testPerSessionInterpreterCloseOnNoteRemoval() throws IOException, DuplicateNameException {
    // create a notes
    Note note1  = notebook.createNote(anonymous, EMPTY_STRING);
    ...
    note1 = notebook.createNote(anonymous, EMPTY_STRING);
  ...
  public void testPerSessionInterpreter() throws IOException, DuplicateNameException {
    ...
    Note note2  = notebook.createNote(anonymous, EMPTY_STRING);
  ...
  @Test
  public void testPerNoteSessionInterpreter() throws IOException, DuplicateNameException {
    // create two notes
    Note note1  = notebook.createNote(anonymous, EMPTY_STRING);
    Paragraph p1 = note1.addParagraph();
  ...
  public void testGetAllNotesWithDifferentPermissions() throws IOException, 
    ...
    Note note = notebook.createNote(new AuthenticationInfo("user1"), EMPTY_STRING);
